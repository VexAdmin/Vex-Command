...
test:
	.venv/bin/python -m pytest backend/tests/test_api.py backend/tests/test_kpis.py backend/tests/test_auth.py backend/tests/test_founder_auth.py backend/tests/test_pipeline.py backend/tests/test_goals.py backend/tests/test_settings.py backend/tests/test_manual_revenue.py -q

test-sql: db-up
	.venv/bin/python -m pytest backend/tests/test_f1_sql.py backend/tests/test_f1_pipeline.py backend/tests/test_f1_goals.py backend/tests/test_f1_manual_revenue.py -q
